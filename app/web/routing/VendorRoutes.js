...
function loadVendorRoutes(app) {
    ...
    app.get(
        Pages.vendor.checkout.route,
        requireRole(['vendor', 'admin']),
        VendorController.checkout
    );

    app.post(
        '/vendor/checkout/qrcode',
        requireRole(['vendor', 'admin']),
        VendorController.generateQRCode
    );
    ...
    app.get(
        '/vendor/items/:id/edit',
        requireRole(['vendor', 'admin']),
        VendorController.showEditItem
    );
    app.post('/vendor/items/:id', requireRole(['vendor', 'admin']), VendorController.updateItem);
    app.post(
        '/vendor/items/:id/delete',
        requireRole(['vendor', 'admin']),
        VendorController.deleteItem
    );
