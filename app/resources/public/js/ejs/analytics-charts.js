document.addEventListener('DOMContentLoaded', function() {
  ...
  const spendingData = spendingChartEl ? JSON.parse(spendingChartEl.dataset.chartData || 'null') : null;
  const categoryData = categoryChartEl ? JSON.parse(categoryChartEl.dataset.chartData || 'null') : null;
          ...
          tooltip: {
            callbacks: {
              label: function(context) {
                ...
                return context.label + ': ' + context.parsed + ' tok (' + percentage + '%)';
              }
            }
          }
        }
