const httpErrors = {
    ...
    407: {
        ...
        message: 'You must authenticate with a proxy server before proceeding.',
    },
    ...
    412: {
        ...
        message: 'The server does not meet one of the preconditions specified in the request.',
    },
    413: {
...
function getErrorData(status) {
    if (httpErrors[status]) {
        ...
        return {
            status,
            title: 'Unknown Error',
            message: 'No information available for this status code.',
        };
    }
}
